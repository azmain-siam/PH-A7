      ...
      <div className="card p-6 border h-full border-[#28282833]">
        <figure>
          <img
            src={recipe_image}
            alt="Shoes"
            className="rounded-xl h-[200px] w-full object-cover object-center"
          />
        </figure>
        <div className="card-body p-0 pt-6">
          ...
          <ul className="text-[#878787] list-disc ml-6">
            <li>{ingredients[0]}</li>
            <li>{ingredients[1]}</li>
            <li>{ingredients[2]}</li>
          </ul>
          ...
          <div className="card-actions">
            <button
              ...
              className="py-3 px-5 bg-[#0BE58A] hover:bg-[#34a073] border-2 border-[#0BE58A] hover:border-[#34a073] text-lg duration-300 rounded-full font-bold text-black"
            >
              Want to Cook
            </button>
          </div>
